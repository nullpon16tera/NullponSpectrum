...
![NullponSpectrum](screenshot/visualizer_20260321.png)

### 設定タブ画面

![NullponSpectrum](screenshot/settings_20260321.png)

下記のビジュアライザーのみ「Realtime saber colors (floor FX)」をオンにすると、Chromaなどのノーツ色が変わって斬ったときにセイバーカラーが変更されたときに色が反映されます。
- Particle Visualizer
- Cut Visualizer
- Stage Visualizer
